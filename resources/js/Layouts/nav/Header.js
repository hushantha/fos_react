...
/// Image
import profile from "../../../public/images/profile/17.jpg";
...
const Header = ({ onNote }) => {
    ...
    return ( <
        ...
        as = "li" >
        <
        Dropdown.Toggle className = "nav-link i-false pointr"
        variant = ""
        data - toggle = "dropdown"
        aria - expanded = "false"
        as = "a" >
        ...
        h6 className = "mb-0" >
        New order placed { " " } <
        strong className = "text-info" > #XF - 2356. <
        /strong> < /
        h6 > <
        p className = "mb-0" >
