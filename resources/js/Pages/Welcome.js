...
import ChartDonught2 from "../components/Sego/Home/donught2";
import ChartDonught3 from "../components/Sego/Home/donught3";
import BarChart from "../components/Sego/Home/BarChart";
// import RadialBarChart from "../components/Sego/Home/RadialBarChart";
import ActivityLineChart from "../components/Sego/Home/ActivityLineChart";
import ActivityLineChart2 from "../components/Sego/Home/ActivityLineChart2";
import ActivityLineChart3 from "../components/Sego/Home/ActivityLineChart3";
import TimeLineChart from "../components/Sego/Home/TimeLineChart";
import TimeLineChart2 from "../components/Sego/Home/TimeLineChart2";
import TimeLineChart3 from "../components/Sego/Home/TimeLineChart3";
...
const RadialBarChart = loadable(() =>
    pMinDelay(
        import ("../components/Sego/Home/RadialBarChart"), 1000)
);
...
function Home() {
    ...
    return ( <
        ...
        <
        ChartDonught3 backgroundColor = "#FFFFFF"
        ...
        id = "myTabContent" >
        <
        Tab.Pane className = "tab-pane fade"
        eventKey = "all-food"
        id = "user"
        role = "tabpanel" >
        <
        ...
        <
        ChartDonught2 backgroundColor = "#53CB50"
        ...
        div className = "d-inline-block mr-3 position-relative donut-chart-sale2" >
        <
        ChartDonught2 backgroundColor = "#FD376F"
        backgroundColor2 = "#FAFAFA"
        height = "100"
        width = "100"
        value = "40" /
