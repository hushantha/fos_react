...
import bg5 from "../../public/images/big/img5.jpg";
import bg1 from "../../public/images/big/img1.jpg";
...
const Widget = () => {
    return ( <
        Fragment > { /* <Ext /> */ } <
        PageTitle activeMenu = "Statistics"
        motherMenu = "Widget" / >
        <
        div className = "row" >
        <
        ...
        <
        Dropdown.Toggle variant = "primary light i-false sharp" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "info light i-false sharp" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "success i-false sharp light" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "primary i-false sharp light" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "primary light sharp i-false" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "info light sharp i-false" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "success light sharp i-false" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "primary light"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "info light"
        className = " i-false sharp" >
        <
        svg width = "18px"
        height = "18px"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "success light"
        className = " i-false sharp" >
        <
        svg width = "18px"
        height = "18px"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "warning light"
        className = " i-false sharp" >
        <
        svg width = "18px"
        height = "18px"
        ...
        div className = "media-body" >
        <
        h5 className = "mb-0" > Do something
        else </h5> <
        small className = "text-muted" >
        29 July 2020 - 02: 26 PM <
        /small> < /
        ...
        <
        span className = "mr-3 bgl-primary text-primary" > { /* <!-- <i className="ti-user"></i> --> */ } <
        ...
        h3 className = "text-white" > 783 K < /h3> < /
        div > <
        /div> < /
        div > <
        /div> < /
        ...
        <
        div className = "progress-bar progress-animated bg-primary"
        style = {
            { width: "80%" }
        } >
        <
        ...
        div className = "progress mb-2" >
        <
        div className = "progress-bar progress-animated bg-warning"
        style = {
            { width: "50%" }
        } >
        <
        ...
        div className = "progress mb-2" >
        <
        div className = "progress-bar progress-animated bg-red"
        style = {
            { width: "76%" }
        } >
        <
        ...
        div className = "progress mb-2" >
        <
        div className = "progress-bar progress-animated bg-success"
        style = {
            { width: "30%" }
        } >
        <
        ...
        Link className = "btn btn-outline-primary btn-rounded mt-3 px-5"
        to = "/widget-basic" >
        Folllow <
        /Link> < /
        div > <
        ...
        div > <
        /div> <
        div className = "chart-wrapper" > { /* <LineChart4 color="#8ED3E2" /> */ } <
        Widget1 / >
        <
        /div> <
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "primary i-false light sharp" >
        <
        svg width = "18px"
        height = "18px"
        viewBox = "0 0 24 24"
        ...
        Dropdown className = "dropdown" >
        <
        Dropdown.Toggle variant = "success light sharp"
        className = " i-false" >
        <
        svg width = "18px"
        height = "18px"
        ...
        /div> < /
        div > <
        div className = "chart-wrapper" > { /* <LineChart4 color="#2780D4" /> */ } <
        TopProducts1 / >
        <
        /div> < /
        div > <
