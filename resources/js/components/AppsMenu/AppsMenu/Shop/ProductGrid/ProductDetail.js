...
import tab1 from "../../../../../public/images/tab/1.jpg";
import tab2 from "../../../../../public/images/tab/2.jpg";
import tab3 from "../../../../../public/images/tab/3.jpg";
import tab4 from "../../../../../public/images/tab/4.jpg";
...
const ProductDetail = ({ match }) => {
    ...
    return ( <
        ...
        div className = "row" >
        <
        div className = "col-xl-3 col-lg-6  col-md-6 col-xxl-5 " > { /* Tab panes */ } <
        ...
        /Tab.Pane> < /
        Tab.Content > <
        div className = "tab-slide-content new-arrival-product mb-4 mb-xl-0" > { /* Nav tabs */ } <
        Nav as = "ul"
        ...
        <
        div className = "product-detail-content" > { /*Product details*/ } <
        div className = "new-arrival-content pr" >
        <
        h4 >
        Solid Women 's V-neck Dark
        T - Shirt <
        /h4> <
        ...
        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alt = "image"
        eration in
        some form, by injected humour,
        or randomised words which don 't
        look even slightly believable.If you are going to use a passage of Lorem Ipsum, you need to be sure there isn 't anything
        embarrassing. <
        /p> <
