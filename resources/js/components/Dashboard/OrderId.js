...
import profile from "../../../public/images/profile/19.jpg";
import profile2 from "../../../public/images/profile/18.jpg";
...
function OrderId() {
    return ( <
        ...
        <
        Dropdown.Toggle className = "i-false btn btn-success dropdown-toggle"
        ...
        >
        <
        path d = "M16.0005 17.3335C18.2096 17.3335 20.0005 15.5426 20.0005 13.3335C20.0005 11.1244 18.2096 9.3335 16.0005 9.3335C13.7913 9.3335 12.0005 11.1244 12.0005 13.3335C12.0005 15.5426 13.7913 17.3335 16.0005 17.3335Z"
        stroke = "#3E4954"
        strokeWidth = { 2 }
        strokeLinecap = "round"
        strokeLinejoin = "round" /
        ...
        <
        span className = "p-3 mr-3 d-inline-block rounded-circle bg-white" >
        <
        svg width = { 28 }
        height = { 28 }
        viewBox = "0 0 28 28"
        ...
        >
        <
        path d = "M4.66667 12.8333H9.33333C9.97762 12.8333 10.5 12.3115 10.5 11.6667C10.5 11.0218 9.97762 10.5 9.33333 10.5H4.66667C4.02238 10.5 3.5 11.0218 3.5 11.6667C3.5 12.3115 4.02238 12.8333 4.66667 12.8333Z"
        fill = "#EA7A9A" /
        >
        <
        path d = "M2.33366 16.3333H5.83366C6.47795 16.3333 7.00033 15.8115 7.00033 15.1667C7.00033 14.5218 6.47795 14 5.83366 14H2.33366C1.68937 14 1.16699 14.5218 1.16699 15.1667C1.16699 15.8115 1.68937 16.3333 2.33366 16.3333Z"
        fill = "#EA7A9A" /
        >
        <
        path d = "M3.49967 8.16683C4.144 8.16683 4.66634 7.64449 4.66634 7.00016C4.66634 6.35583 4.144 5.8335 3.49967 5.8335C2.85534 5.8335 2.33301 6.35583 2.33301 7.00016C2.33301 7.64449 2.85534 8.16683 3.49967 8.16683Z"
        fill = "#EA7A9A" /
        >
        <
        path d = "M2.33366 20.9998C2.97799 20.9998 3.50033 20.4775 3.50033 19.8332C3.50033 19.1888 2.97799 18.6665 2.33366 18.6665C1.68933 18.6665 1.16699 19.1888 1.16699 19.8332C1.16699 20.4775 1.68933 20.9998 2.33366 20.9998Z"
        fill = "#EA7A9A" /
        >
        <
        /svg> < /
