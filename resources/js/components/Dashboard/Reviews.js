...
function Reviews() {
    return ( <
        ...
        <
        img className = "mr-3 img-fluid btn-rounded"
        width = { 55 }
        src = { avatar1 }
        alt = "avatar1" /
        >
        ...
        We recently had dinner with friends at David CC and we all walked away with a great experience.Good food, pleasant environment,
        personal attention through all the evening.Thanks to the team and we will be back!
        <
        /p> < /
        div > <
