...
import { Dropdown, Nav, Tab, Carousel } from "react-bootstrap";
//** Import Image */
          ...
          <Dropdown className="dropdown custom-dropdown mb-4">
            ...
            <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
              <Dropdown.Item className="dropdown-item" eventKey="all">
                <Nav.Link to="#">4 June 2020 - 4 July 2020</Nav.Link>
              </Dropdown.Item>
              <Dropdown.Item className="dropdown-item" eventKey="all">
                <Nav.Link to="#">5 july 2020 - 4 Aug 2020</Nav.Link>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </div>
                    ...
                    <div className="card">
                      ...
                      <div className="card-body p-0">
                        <div className="media review-box">
                          ...
                          <div className="media-body">
                            ...
                            <ul className="review-meta mb-3 d-block d-sm-flex align-items-center">
                              ...
                              <li className="ml-auto">
                                <span className="badge badge-rounded text-warning light font-w500">
                                  Excelent
                                </span>
                              </li>
                            </ul>
                            <p className="mb-3 text-secondary mr-1">
                          ...
                          <div className="media-footer align-self-center">
                            <div className="star-review text-md-center">
                              <span className="text-secondary mr-1">4.5</span>
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                            </div>
                          </div>
                        </div>
                        <div className="media review-box">
                          ...
                          <div className="media-body">
                            ...
                            <ul className="review-meta mb-3 d-block d-sm-flex align-items-center">
                              ...
                              <li className="ml-auto">
                                ...
                                <span className="badge badge-rounded text-warning light font-w500 ml-1">
                                  Great
                                </span>
                              </li>
                            </ul>
                        ...
                        <div className="media review-box">
                          ...
                          <div className="media-footer align-self-center">
                            <div className="star-review text-md-center">
                              <span className="text-secondary mr-1">4.0</span>
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                        ...
                        <div className="media review-box">
                          ...
                          <div className="media-footer align-self-center">
                            <div className="star-review text-md-center">
                              <span className="text-secondary mr-1">2.0</span>
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                        ...
                        <div className="media review-box">
                          ...
                          <div className="media-footer align-self-center">
                            <div className="star-review text-md-center">
                              <span className="text-secondary mr-1">3.0</span>
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                        ...
                        <div className="media review-box">
                          ...
                          <div className="media-footer align-self-center">
                            <div className="star-review text-md-center">
                              <span className="text-secondary mr-1">1.0</span>
                              <i className="fa fa-star text-primary mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
                              <i className="fa fa-star text-gray mr-1" />
