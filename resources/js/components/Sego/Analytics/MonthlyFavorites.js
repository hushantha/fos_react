...
const MonthlyFavorites = () => {
    ...
    const [datas, setDatas] = useState([{
        ...
        {
            img: dish_pic10,
            details: "Tuna soup spinach with himalaya salt	",
            reviews: "451",
            likes: "256k",
        },
        {
    ...
    return ( <
        div >
        <
        PerfectScrollbar className = "row height750 dz-scroll loadmore-content"
        id = "favourite-itemsContent" > {
            ...
            datas.map((data, index) => ( <
                ...
                to = "ecom-product-detail" > { data.details } <
                /Link> < /
                h5 > <
                div className = "star-review fs-14 mb-3" >
                <
                i className = "fa fa-star text-orange mr-1" / >
                <
                i className = "fa fa-star text-orange mr-1" / >
                <
                i className = "fa fa-star text-orange mr-1" / >
                ...
                i className = "fa fa-star text-gray mr-1" / >
                <
                span className = "ml-3 text-dark" > { data.reviews }
                reviews <
                /span> < /
                div > <
                Link to = "#;"
