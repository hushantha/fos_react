...
//** Import Image */
import Product5 from "../../../../public/images/card/pic5.jpg";
import Product6 from "../../../../public/images/card/pic6.jpg";
import Product7 from "../../../../public/images/card/pic7.jpg";
...
const OrderIdDada = () => {
    ...
    return ( <
            ...
            datas.map((data, index) => ( <
                ...
                <
                img className = "mr-3 img-fluid rounded"
                width = { 85 }
                src = { data.img }
                alt = "Product5" /
                >
                ...
                td >
                <
                h4 className = "my-0 text-black font-w600" > { data.quantity }
                x <
                /h4> < /
                td > <
                td >
