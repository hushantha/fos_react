...
const ReviewSlider = () => {
    ...
    return ( <
        ...
        div >
        <
        h3 className = "card-title mb-1 fs-28 font-w600" > 🔥Newest <
        /h3> < /
        div > <
        div className = "testimonial-one-navigation owl-clienr-btn pull-left" > { renderArrows() } <
        /div> < /
        div > <
        ...
        div className = "" >
        <
        p className = "mb-3" > “This was not just great cooking but exceptional cooking using only the best ingredients. <
        /p> <
        p className = "mb-3" >
        ...
        <
        img className = "mr-3 img-fluid rounded-circle"
        width = { 50 }
        src = { avatar1 }
        alt = "avatar1" /
        >
        ...
        <
        h4 className = "mt-0 mb-1 text-black" >
        James Kowalski <
        /h4> <
