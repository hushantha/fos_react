...
import img2 from "../../../public/images/card/2.png";
import img3 from "../../../public/images/card/3.png";
/// Bootstrap
...
const UiCards = () => {
    return ( <
        ...
        <
        Card.Text >
        He lay on his armour - like back, and
        if he lifted his head a little he could see his brown belly,
        slightly domed and divided by arches into stiff { " " } <
        br / > sections.The bedding was hardly able to cover it and seemed ready to slide off any moment. <
        /Card.Text> < /
        Card.Body > <
